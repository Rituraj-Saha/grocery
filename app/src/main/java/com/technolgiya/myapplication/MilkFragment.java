        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists()) {
                    ...
                    final FirebaseRecyclerAdapter<fresh_model, MilkFragment.subcategory_list> firebaseRecyclerAdapter =
                            new FirebaseRecyclerAdapter<fresh_model, MilkFragment.subcategory_list>(options) {


                                @Override
                                protected void onBindViewHolder(@NonNull final MilkFragment.subcategory_list holder,
                                ...
                                @NonNull
                                @Override
                                public MilkFragment.subcategory_list onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                                    View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.menu_search_design, parent, false);
                                    MilkFragment.subcategory_list viewHolder = new MilkFragment.subcategory_list(view);
                                    return viewHolder;
                                }
                            };
