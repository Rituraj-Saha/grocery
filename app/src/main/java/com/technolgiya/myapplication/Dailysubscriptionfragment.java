 ...
 */
public class Dailysubscriptionfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dailysubscription, container, false);
        subproref = FirebaseDatabase.getInstance().getReference().child("Location").child("North 24 Parganas").child("subscribeD")
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<cart_model,Dailysubscriptionfragment.subList> FirebaseRecyclearAdaptor =
                new FirebaseRecyclerAdapter<cart_model, Dailysubscriptionfragment.subList>(options_sub_detail) {
                    @Override
                    protected void onBindViewHolder(@NonNull Dailysubscriptionfragment.subList holder, int position, @NonNull cart_model model) {
                    ...
                    @NonNull
                    @Override
                    public Dailysubscriptionfragment.subList onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cart_retrive_design, parent, false);
                        Dailysubscriptionfragment.subList viewHolder = new Dailysubscriptionfragment.subList(view);
                        return viewHolder;
                    }
                };
